...
import com.smartrm.smartrmmonolith.commodity.adapter.convertor.plaintext.CurrencyPropertyTextParser;
import com.smartrm.smartrmmonolith.commodity.adapter.convertor.plaintext.DatePropertyTextParser;
import com.smartrm.smartrmmonolith.commodity.adapter.convertor.plaintext.DateTimePropertyTextParser;
import com.smartrm.smartrmmonolith.commodity.adapter.convertor.plaintext.FloatPropertyTextParser;
import com.smartrm.smartrmmonolith.commodity.adapter.convertor.plaintext.ImageUrlPropertyTextParser;
import com.smartrm.smartrmmonolith.commodity.adapter.convertor.plaintext.IntegerPropertyTextParser;
import com.smartrm.smartrmmonolith.commodity.adapter.convertor.plaintext.MapPropertyTextParser;
import com.smartrm.smartrmmonolith.commodity.adapter.convertor.plaintext.StringPropertyTextParser;
